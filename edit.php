											...
											if ($stmt->rowCount() == 0){
												...
												if ($stmt->rowCount() == 1) {
													...
													$expirationTime = $issuedAt + 60*60;
														  ...
														  $jwt = JWT::encode($token, $key);
															sendMail($email, 'Email confirm - BlogYourOpinion',"Hey $name verifiy your email with the following link https://".$_SERVER['SERVER_NAME']."/blogyouropinion/edit.php?action=edit-mail-confirm&id=$jwt");
