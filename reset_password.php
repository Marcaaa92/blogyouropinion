							...
							if(isset($_POST["reset"])){
								if($_POST["reset"]=="sendMail"){
									...
									if ($stmt->rowCount() == 1) {
										...
										sendMail($email, 'Edit password - BlogYourOpinion', "Hey $name confirm your action to edit password following this link https://".$_SERVER['SERVER_NAME']."/blogyouropinion/reset_password.php?action=setPassword&id=$jwt, if you have not requested a change of password, ignore this mail");
