											...
											if ($stmt->rowCount() == 0) {
												  ...
												  if ($stmt->rowCount() == 0) {
													...
													$jwt = JWT::encode($token, $key);
													 ...
													 sendMail($email, 'Email confirm - BlogYourOpinion', "Hey $name confirm your email following this link https://".$_SERVER['SERVER_NAME']."/register_page.php?action=confirm&id=$jwt");
