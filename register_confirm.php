			...
			<div class="column">
				<?php
					...
					try{
						  ...
						  if ($stmt->rowCount() == 1){
							  echo '<h2 class="title is-4 " style="text-align:center">Risultato: Email gia confermata</h2>';
						  }
						  else{
							...
							echo '<h2 class="title is-4" style="text-align:center">Risultato: Email confermata con successo</h2>';
						  }
						} catch (Exception $e) {
